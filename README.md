...
- **Upcoming Innovations Roadmap**: Comprehensive technical blueprint for in-progress and planned innovations (SDT Keystroke & Diff Debugging Diagnostic, Live What-If-Skip Date Simulation, Calibration Matrix). (See `docs/INNOVATIONS_TO_BE_DONE.md` and `docs/INNOVATIONS_ROADMAP.md`)
