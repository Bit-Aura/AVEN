  ...
  return (
    <div className="flex flex-col items-end gap-1.5 select-none">
      <div className="flex items-center gap-2">
        ...
        <span className="text-xs font-bold uppercase tracking-wider text-aven-text-subtle">Bayesian Readiness:</span>
      ...
      <div className="w-48 h-2 bg-aven-surface rounded-full overflow-hidden border border-aven-border">
        <div 
          className="h-full bg-gradient-to-r from-indigo-500 to-emerald-400 transition-all duration-700"
          style={{ width: `${clamped}%` }}
        />
      </div>
      <p className="text-[10px] text-aven-text-muted text-right">
