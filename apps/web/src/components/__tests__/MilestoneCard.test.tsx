...
describe('MilestoneCard Component', () => {
  it('renders milestone details', () => {
    (usePathStore as unknown as jest.Mock).mockImplementation((selector) => selector({
      ...baseMock,
      activeMilestone: { id: "m1", title: "Python Basics", status: "active", explanation: "Learn python." },
      openCoach: jest.fn(),
      openProofCard: jest.fn()
    }));
    render(<MilestoneCard milestone={{ id: "m1", title: "Python Basics", status: "active", explanation: "Learn python." } as any} />);
